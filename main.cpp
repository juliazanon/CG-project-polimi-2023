		...
		switch(currScene) {
		  case 0:
			  ...
			  ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				  glm::translate(glm::mat4(1), glm::vec3(-2.1, 8.1, 2.1));
			  ubo.mvpMat = ViewPrj * ubo.mMat;
			  DS4.map(currentImage, &ubo, sizeof(ubo), 0);
			  DS4.map(currentImage, &gubo, sizeof(gubo), 1);

			  ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				  glm::translate(glm::mat4(1), glm::vec3(0, 8.1, 2.1));
			  ubo.mvpMat = ViewPrj * ubo.mMat;
			 ...
			 // middle front
			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) * 
				glm::translate(glm::mat4(1), glm::vec3(-2.1, 6, 2.1));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			DS1.map(currentImage, &ubo, sizeof(ubo), 0);
			DS1.map(currentImage, &gubo, sizeof(gubo), 1);

			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) * 
				glm::translate(glm::mat4(1), glm::vec3(0, 6, 2.1));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			...
			// bottom front
			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(-2.1, 3.9, 2.1));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			DS7.map(currentImage, &ubo, sizeof(ubo), 0);
			DS7.map(currentImage, &gubo, sizeof(gubo), 1);

			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(0, 3.9, 2.1));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			...
			// top middle
			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(-2.1, 8.1, 0));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			DS10.map(currentImage, &ubo, sizeof(ubo), 0);
			DS10.map(currentImage, &gubo, sizeof(gubo), 1);

			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(0, 8.1, 0));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			...
			// middle middle
			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(-2.1, 6, 0));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			...
			// bottom middle
			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(-2.1, 3.9, 0));
			ubo.mvpMat = ViewPrj * ubo.mMat;
			DS15.map(currentImage, &ubo, sizeof(ubo), 0);
			DS15.map(currentImage, &gubo, sizeof(gubo), 1);

			ubo.mMat = glm::scale(glm::mat4(1), glm::vec3(0.2)) *
				glm::translate(glm::mat4(1), glm::vec3(0, 3.9, 0));
			ubo.mvpMat = ViewPrj * ubo.mMat;
